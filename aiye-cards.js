...
export const CARDS = [
    ...
    {name: "#04a", mask: 14, type: "neutral", costType:0, cost: 3, effect: ["xsp", "to", 'seedlight', 'seedlight', 'seedlight'], pv: 2, extra: [], qty: 3 },
    {name: "#04b", mask: 14, type: "neutral", costType:0, cost: 3, effect: ['xseedlight', "to", 'seeddark', 'seeddark', 'seeddark'], pv: 2, extra: [], qty: 3 },
    
    {name: "#05a", mask: 18, type: "neutral", costType:0, cost: 3, effect: ['seedgain', "split"], pv: 2, extra: [], qty: 4 },
    ...
    {name: "#08a", mask: 11, type: "moon", costType:1, cost: 1, effect: ['seedlight', 'seeddark', 'card'], pv: 2, extra: [], qty: 3 },
    {name: "#08b", mask: 11, type: "sun", costType:2, cost: 1, effect: ['seedlight', 'seeddark', 'card'], pv: 2, extra: [], qty: 3 },
    
    {name: "#05b", mask: 19, type: "neutral", costType:0, cost: 2, effect: ['seedgain'], pv: 2, extra: [], qty: 2 },
    {name: "#05c", mask: 19, type: "neutral", costType:0, cost: 2, effect: ['seedgain'], pv: 2, extra: [], qty: 2 },
    ...
    //{name: "#00", mask: 2, type: "sun", costType:0, cost: 3, effect: ['seedgain', "split"], pv: 2, extra: [], qty: 1 },
    //{name: "#00", mask: 1, type: "moon", costType:0, cost: 1, effect: ['attack', 'merge'], pv: 2, extra: [], qty: 1 },
    //{name: "#00", mask: 2, type: "sun", costType:0, cost: 3, effect: ['seedgain', 'card'], pv: 2, extra: [], qty: 1 },
    //{name: "#00", mask: 4, type: "neutral", costType:0, cost: 5, effect: ['defense', 'merge'], pv: "0", extra: [ "p5","p8","p11","per", "pair"], qty: 1 },
    {name: "#04c", mask: 14, type: "moon", costType:1, cost: 1, effect: ['xcard', "to", 'seedjoker', 'seedjoker', 'seedjoker'], pv: 2, extra: [], qty: 2 },
    {name: "#04d", mask: 14, type: "sun", costType:2, cost: 1, effect: ['xcard', "to", 'seedjoker', 'seedjoker', 'seedjoker'], pv: 2, extra: [], qty: 2 },
    ...
    {name: "e09", mask: 3, type: "neutral", costType:0, cost: 5, effect: ['seedjoker', 'card'], pv: "0", extra: ["p5", "p8", "p11", "per", "sun", "sun"], qty: 1 , value: VALUES.tier},
    {name: "e10", mask: 3, type: "neutral", costType:0, cost: 5, effect: ['seedjoker', 'card'], pv: "0", extra: ["p5", "p8", "p11", "per", "moon", "moon"], qty: 1 },
...
export const CARDSO = [
    ...
    {name: "#00", mask: 1, type: "moon", cost: 1, effect: ["xsp", "to", 'seedlight', 'seedlight'], pv: 2, extra: [], qty: 1 },
    {name: "#00", mask: 2, type: "sun", cost: 1, effect: ["xsp", "to", 'seedlight', 'seedlight'], pv: 2, extra: [], qty: 1 },

    {name: "#00", mask: 1, type: "moon", cost: 3, effect: ["xsp", "to", 'attack', 'seedlight'], pv: 4, extra: [], qty: 1 },
    {name: "#00", mask: 2, type: "sun", cost: 3, effect: ["xsp", "to", 'attack', 'seedlight'], pv: 4, extra: [], qty: 1 },
    {name: "#00", mask: 2, type: "sun", cost: 3, effect: ["xso", "to", 'seedlight', 'seedlight', 'seedlight'], pv: 4, extra: [], qty: 1 },

    {name: "#00", mask: 1, type: "moon", cost: 3, effect: ['seedlight', 'card'], pv: 4, extra: [], qty: 1 },
    {name: "#00", mask: 1, type: "moon", cost: 1, effect: ['card'], pv: 2, extra: [], qty: 1 },
    {name: "#00", mask: 2, type: "sun", cost: 0, effect: ['card'], pv: 0, extra: ["initial"], qty: MAX_PLAYERS * 1 },

    {name: "#00", mask: 1, type: "moon", cost: 3, effect: ['xcard', "to", 'seedjoker', 'seedjoker', 'seedjoker'], pv: 4, extra: [], qty: 1 },
    {name: "#00", mask: 2, type: "sun", cost: 3, effect: ['xcard', "to", 'seedjoker', 'seedjoker', 'seedjoker'], pv: 4, extra: [], qty: 1 },


    {name: "#00", mask: 5, type: "moon", cost: 5, effect: ['xcard', "to", 'seedjoker', 'seedjoker', 'seedjoker'], pv: 15, extra: ["pn1", "per", 'card'], qty: 1 },
    ...
    {name: "#00", mask: 1, type: "moon", cost: 3, effect: ['seedgain'], pv: 4, extra: [], qty: 2 },
    {name: "#00", mask: 2, type: "sun", cost: 3, effect: ['seedgain'], pv: 4, extra: [], qty: 2 },
